...
const VALID_INSTRUMENTS = ['guitar', 'ukulele', 'piano'];
...
export const getSongData = async (
  ...
  // Validate instrument to prevent prompt injection
  // Even though it's typed as Instrument, runtime values could be arbitrary strings
  const safeInstrument = VALID_INSTRUMENTS.includes(instrument as string)
    ? instrument
    : 'guitar';

...
export const getSongData = async (
  ...
  // Validate and sanitize the instrument to prevent prompt injection at runtime
  const validInstruments: Instrument[] = ['guitar', 'ukulele', 'piano'];
  const safeInstrument = validInstruments.includes(instrument as Instrument) ? instrument : 'guitar';

...
function AppContent() {
  ...
  // Optimization: Passing JSX elements (e.g. <HomeView />) rather than executing functions on render (e.g. renderHome())
  // prevents execution of expensive operations and DOM re-creation on inactive routes every time parent state changes.
  return (

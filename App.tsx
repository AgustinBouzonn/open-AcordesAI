...
// Extracted views to prevent re-rendering when AppContent state changes
const HomeView = ({
  searchQuery,
  setSearchQuery,
  handleSearch
...
const FavoritesView = ({ loadSong, navigate }: { loadSong: (id: string) => void, navigate: (path: string) => void }) => {
...
const HistoryView = ({ loadSong }: { loadSong: (id: string) => void }) => {

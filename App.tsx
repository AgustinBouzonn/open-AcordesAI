...
const HomeView = React.memo(({ searchQuery, setSearchQuery, handleSearch }: { searchQuery: string, setSearchQuery: (val: string) => void, handleSearch: (e: React.FormEvent) => void }) => (
...
const SearchView = React.memo(({ searchQuery, setSearchQuery, handleSearch, isSearching, searchResults, loadSong }: { searchQuery: string, setSearchQuery: (val: string) => void, handleSearch: (e: React.FormEvent) => void, isSearching: boolean, searchResults: SongSearchResult[], loadSong: (id: string, title?: string, artist?: string) => void }) => (
...
const FavoritesView = React.memo(({ navigate, loadSong }: { navigate: ReturnType<typeof useNavigate>, loadSong: (id: string) => void }) => {
...
const SongDetailView = React.memo(({ isLoadingSong, currentSong, handleInstrumentChange, loadingInstrument }: { isLoadingSong: boolean, currentSong: Song | null, handleInstrumentChange: (instrument: Instrument) => Promise<void> | void, loadingInstrument: boolean }) => {
  if (isLoadingSong) {
    return (
...
function AppContent() {
  ...
  const loadSong = React.useCallback(async (id: string, title?: string, artist?: string) => {
  ...
  const handleInstrumentChange = React.useCallback(async (instrument: Instrument) => {

...
import { Home, SearchResults, Favorites, History, SongDetail } from './components/AppViews';
  ...
  return (
    <Layout activeTab={activeTab} onNavigate={(tab) => {
      ...
      <Routes>
        ...
        <Route path="/favorites" element={<Favorites onLoadSong={loadSong} />} />
        <Route path="/history" element={<History onLoadSong={loadSong} />} />

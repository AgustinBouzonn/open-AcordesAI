...
// Extracted SearchView component
...
// Extracted FavoritesView component
...
// Extracted HistoryView component
...
function AppContent() {
  ...
  const onTrendingClick = React.useCallback((term: string) => {
    setSearchQuery(term);
    performSearch(term);
  }, [performSearch]);
  ...
  const onNavigateSearch = React.useCallback(() => navigate('/search'), [navigate]);

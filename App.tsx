...
// ⚡ Bolt: Extracted React Router views as React.memo components to prevent unnecessary re-renders.
...
const SearchView = React.memo(({
  ...
  loadSong: (id: string, title?: string, artist?: string) => void | Promise<void>;
}) => (
...
const FavoritesView = React.memo(({ loadSong, navigate }: { loadSong: (id: string) => void | Promise<void>, navigate: (path: string) => void }) => {
...
const HistoryView = React.memo(({ loadSong }: { loadSong: (id: string) => void | Promise<void> }) => {
    ...
    <Layout activeTab={activeTab} onNavigate={(tab) => {
      ...
      <Routes>
        ...
        <Route path="/favorites" element={
          <FavoritesView loadSong={loadSong} navigate={navigate} />
        } />
        <Route path="/history" element={
          <HistoryView loadSong={loadSong} />
        } />

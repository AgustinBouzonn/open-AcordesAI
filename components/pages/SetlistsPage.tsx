    ...
    <div className="space-y-6">
      ...
      {creating && (
        <div className="bg-dark-800 border border-dark-700 rounded-xl p-4 flex gap-2">
          ...
          <button onClick={() => { setCreating(false); setNewName(''); }} className="bg-dark-700 hover:bg-dark-600 text-gray-300 px-4 rounded-lg" aria-label="Cancelar creación"><X size={16} /></button>
        </div>
      )}
              ...
              <div className="p-4 flex items-center gap-3">
                ...
                {renamingId === sl.id ? (
                  <>
                    ...
                    <button onClick={() => setRenamingId(null)} className="p-2 text-gray-400 hover:text-white" aria-label="Cancelar renombre"><X size={16} /></button>
                  </>
                ) : (
                  <>
                    ...
                    <button onClick={() => void remove(sl.id)} className="p-2 text-gray-400 hover:text-red-400" title="Eliminar" aria-label="Eliminar setlist"><Trash2 size={16} /></button>
                  </>
                )}
              </div>

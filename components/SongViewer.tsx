  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="sticky top-20 md:top-24 z-30 bg-dark-800/95 backdrop-blur-md rounded-xl border border-dark-600 shadow-xl flex flex-col md:flex-row items-center justify-between p-2 gap-3">
        ...
        {/* Instrument Selector */}
        <div
            className="flex p-1 bg-dark-900 rounded-lg w-full md:w-auto"
            role="group"
        ...
        <div className="flex items-center justify-between w-full md:w-auto gap-4 px-2">
            ...
            <button type="button" aria-label="Reducir tamaño de letra" title="Reducir tamaño de letra" onClick={() => setFontSize(s => Math.max(12, s - 2))} className="p-2 text-gray-400 hover:text-white focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none rounded-md"><Minus size={16} aria-hidden="true" /></button>
            <Type size={18} className="text-brand" aria-hidden="true" />
            <button type="button" aria-label="Aumentar tamaño de letra" title="Aumentar tamaño de letra" onClick={() => setFontSize(s => Math.min(24, s + 2))} className="p-2 text-gray-400 hover:text-white focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none rounded-md"><Plus size={16} aria-hidden="true" /></button>
            </div>

      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-dark-700">
        ...
        <div className="flex items-center gap-3">
          <button 
            ...
            className={`p-3 rounded-full transition focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none cursor-pointer ${isFav ? 'bg-brand text-white' : 'bg-dark-700 text-gray-400 hover:bg-dark-600'}`}
          >
          ...
          <button 
             ...
             className="p-3 rounded-full bg-dark-700 text-gray-400 hover:bg-dark-600 hover:text-white transition relative focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none cursor-pointer"
          >
      ...
      <div className="sticky top-20 md:top-24 z-30 bg-dark-800/95 backdrop-blur-md rounded-xl border border-dark-600 shadow-xl flex flex-col md:flex-row items-center justify-between p-2 gap-3">
        ...
        <div className="flex items-center justify-between w-full md:w-auto gap-4 px-2">
            ...
            <button
              ...
              className="p-2 text-gray-400 hover:text-white focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none cursor-pointer"
            >
              <Minus size={16} />
            </button>
            ...
            className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-medium transition focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none cursor-pointer ${autoScrollSpeed > 0 ? 'bg-brand text-white' : 'bg-dark-700 text-gray-300'}`}
            >

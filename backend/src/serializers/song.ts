...
export const serializeSong = (row: SongRow) => {
  // ⚡ Bolt: Removed Object.fromEntries(Object.entries({...}).filter(...))
  // Manual object construction avoids significant allocation overhead of intermediate
  // arrays and objects in this performance-critical data path.

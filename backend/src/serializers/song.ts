...
export const serializeSong = (row: SongRow) => {
  // ⚡ Bolt: Replaced Object.fromEntries(Object.entries(...).filter(...)) with manual construction.
  // Impact: Eliminates significant intermediate object/array allocation overhead when mapping large sets of rows.

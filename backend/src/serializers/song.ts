...
export const serializeSong = (row: SongRow) => {
  ...
  // Use manual object construction and conditional assignments
  // instead of Object.fromEntries(Object.entries({...}).filter(...))
  // to avoid creating intermediate arrays and objects.

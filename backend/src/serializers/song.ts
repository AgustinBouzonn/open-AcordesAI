...
/**
 * Optimizes serialization by replacing the previous `Object.fromEntries(Object.entries({...}).filter(...))` pattern.
 * This manual conditional assignment avoids allocating intermediate arrays and objects,
 * significantly reducing memory overhead and improving performance in this critical path.
 */

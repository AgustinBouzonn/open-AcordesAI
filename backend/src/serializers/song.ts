...
// ⚡ Bolt Optimization: Replacing Object.fromEntries(Object.entries().filter())
// with manual object construction prevents the allocation of an intermediate
// object, an array of entries, and the filtered array for every song serialized.
// This is critical for performance when returning large arrays of songs from the DB.

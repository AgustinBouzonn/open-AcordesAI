...
// Optimized: Replaced Object.fromEntries(Object.entries(...).filter(...))
// with manual construction and conditional assignments.
// This significantly reduces intermediate object/array allocations
// and GC pressure in this high-throughput serialization path.

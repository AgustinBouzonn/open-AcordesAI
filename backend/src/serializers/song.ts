...
// ⚡ Bolt: Replaced Object.fromEntries(Object.entries({...}).filter(...)) with manual
// construction to eliminate multiple temporary object/array allocations per song row.
// This significantly reduces GC pressure in bulk list serialization endpoints.

...
export const serializeSong = (row: SongRow) => {
  // ⚡ Bolt Optimization: Use manual object construction instead of
  // Object.fromEntries(Object.entries(...).filter(...)) to eliminate
  // significant intermediate array/object allocations during serialization.

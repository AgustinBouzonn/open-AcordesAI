...
// ⚡ Bolt: Replaced Object.fromEntries(Object.entries(...).filter(...)) with manual object construction.
// This eliminates intermediate array allocations and iteration overhead during critical path serialization.

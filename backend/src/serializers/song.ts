...
export const serializeSong = (row: SongRow) => {
  // ⚡ Bolt: Replaced Object.fromEntries(Object.entries({...}).filter(...))
  // with manual construction to eliminate allocation overhead of intermediate
  // objects and arrays, significantly improving performance for bulk serialization.

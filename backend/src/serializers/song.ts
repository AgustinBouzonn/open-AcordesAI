...
/**
 * Serializes a song row into a consistent response format.
 * Optimized by avoiding Object.entries() and Object.fromEntries()
 * which create unnecessary intermediate arrays and objects.
 */

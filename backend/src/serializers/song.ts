...
export const serializeSong = (row: SongRow) => {
  // Performance optimization: Using manual object construction instead of
  // Object.fromEntries(Object.entries({...}).filter(...)) to avoid significant
  // allocation overhead from intermediate arrays and objects on hot paths.
  ...
  if (youtubeUrl !== undefined && youtubeUrl !== null) result.youtubeUrl = youtubeUrl;

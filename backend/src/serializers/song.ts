...
// Replaced Object.fromEntries(Object.entries({...}).filter(...)) with manual object construction.
// This avoids allocating multiple intermediate objects and arrays per row,
// significantly improving throughput and reducing GC overhead on bulk song queries.
